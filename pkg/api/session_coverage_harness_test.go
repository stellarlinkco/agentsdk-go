...
func TestSessionCoverageHarness(t *testing.T) {
	...
	tests := []struct {
		...
		{"TestDescribeRuleFormatsNicely", TestDescribeRuleFormatsNicely},
		{"TestDiscoverPluginsPropagatesScanError", TestDiscoverPluginsPropagatesScanError},
		{"TestEnabledPluginMapTrimsKeys", TestEnabledPluginMapTrimsKeys},
		{"TestEnabledPluginsFiltering", TestEnabledPluginsFiltering},
		...
		{"TestNormalizePluginHooksDropsEmpty", TestNormalizePluginHooksDropsEmpty},
		...
		{"TestParseMCPEntryBuildsCommandSpec", TestParseMCPEntryBuildsCommandSpec},
		{"TestParseMCPEntryIgnoresInvalidTypes", TestParseMCPEntryIgnoresInvalidTypes},
		{"TestPermissionRequestDecisionMapping", TestPermissionRequestDecisionMapping},
		{"TestPluginMCPServersRespectsEnableDisable", TestPluginMCPServersRespectsEnableDisable},
		...
		{"TestSettingsMCPHelpersNilSafe", TestSettingsMCPHelpersNilSafe},
		{"TestShouldRegisterTaskTool", TestShouldRegisterTaskTool},
		{"TestSnapshotPluginsNormalizesHooksAndSorting", TestSnapshotPluginsNormalizesHooksAndSorting},
		{"TestSnapshotSandboxEmpty", TestSnapshotSandboxEmpty},
		{"TestStringSetTrimsAndDedups", TestStringSetTrimsAndDedups},
