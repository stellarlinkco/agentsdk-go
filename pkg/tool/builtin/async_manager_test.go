...
func TestAsyncCoverageHarness(t *testing.T) {
	...
	t.Run("TestBashSpoolWriterHandlesNilReceiver", TestBashSpoolWriterHandlesNilReceiver)
	t.Run("TestBashSpoolWriterTruncatesAfterFactoryError", TestBashSpoolWriterTruncatesAfterFactoryError)
	t.Run("TestBashSpoolWriterTruncatesAfterFileWriteFailure", TestBashSpoolWriterTruncatesAfterFileWriteFailure)
	t.Run("TestBashSpoolWriterTruncatesAfterClosedFile", TestBashSpoolWriterTruncatesAfterClosedFile)
	...
	t.Run("TestBashSpoolWriterWritesToOpenFile", TestBashSpoolWriterWritesToOpenFile)
